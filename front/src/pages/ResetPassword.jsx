        ...
        <div style={{
          ...
          {success ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontSize: 13, color: '#8b8990', lineHeight: 1.6, marginBottom: 20 }}>
                Tu contraseña fue actualizada exitosamente.
              </div>
              <div style={{ fontSize: 13, color: '#8b8990' }}>
                Redirigiendo en{' '}
                <span style={{ color: '#4ae8d0', fontWeight: 700 }}>{countdown}s</span>
                ...
              </div>
              <Link
                to="/login"
                ...
                <div style={{
                  ...
                  {!token && (
                    <div style={{ marginTop: 10 }}>
                      <Link to="/forgot-password" style={{ color: '#4ae8d0', fontSize: 13 }}>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  ...
                  <input
                    ...
                    disabled={!token}
                    style={{ ...inputStyle, opacity: !token ? 0.4 : 1 }}
                ...
                <button
                  ...
                  style={{
                    ...
                    background: loading || !token ? 'rgba(74,232,208,0.3)' : '#4ae8d0',
